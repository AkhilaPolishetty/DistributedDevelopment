...
namespace EventManagement.SMSReference {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="CompositeType", Namespace="http://schemas.datacontract.org/2004/07/LoginAndSMS")]
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SMSservice", ReplyAction="http://tempuri.org/IService1/SMSserviceResponse")]
        System.Threading.Tasks.Task<string> SMSserviceAsync(string subject, string message, long MobileNumber, string carrierGateway);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<EventManagement.SMSReference.IService1>, EventManagement.SMSReference.IService1 {
        ...
        public string SMSservice(string subject, string message, long MobileNumber, string carrierGateway) {
            return base.Channel.SMSservice(subject, message, MobileNumber, carrierGateway);
        }
        
        public System.Threading.Tasks.Task<string> SMSserviceAsync(string subject, string message, long MobileNumber, string carrierGateway) {
            return base.Channel.SMSserviceAsync(subject, message, MobileNumber, carrierGateway);
        }
    }
}
